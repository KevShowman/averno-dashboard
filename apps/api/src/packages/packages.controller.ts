...
export class PackagesController {
  ...
  @Roles(Role.PATRON, Role.DON, Role.CAPO, Role.ROUTENVERWALTUNG, Role.RUTAS, Role.LOGISTICA, Role.SICARIO, Role.LINCE)
  ...
  @Post('price')
  @Roles(Role.PATRON, Role.DON, Role.CAPO, Role.ROUTENVERWALTUNG, Role.RUTAS)
  ...
  @Get('deposits/recent')
  @Roles(Role.PATRON, Role.DON, Role.CAPO, Role.ROUTENVERWALTUNG, Role.RUTAS, Role.LOGISTICA, Role.LINCE)
  async getRecentDeposits() {
    return this.packagesService.getRecentDeposits();
  }

  @Get('archives')
  @Roles(Role.PATRON, Role.DON, Role.CAPO, Role.ROUTENVERWALTUNG, Role.RUTAS, Role.LOGISTICA)
