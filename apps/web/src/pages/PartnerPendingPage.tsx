  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-gray-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div 
      ...
      <div className="relative w-full max-w-lg">
        <div className="absolute -inset-4 bg-gradient-to-r from-amber-500/10 via-gray-500/10 to-amber-500/10 rounded-3xl blur-2xl opacity-60 pointer-events-none" />
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="relative p-6 bg-gradient-to-br from-amber-500/20 to-amber-600/10 rounded-full border border-amber-500/30">
            ...
            <Link
              to="/login"
              className="mt-8 flex items-center justify-center gap-2 py-3 px-4 text-gray-400 hover:text-white transition-colors"
            >
