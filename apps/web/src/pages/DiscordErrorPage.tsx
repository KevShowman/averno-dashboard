      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <Card className="bg-gradient-to-br from-red-900/20 to-red-800/10 border-red-500/30 shadow-2xl">
          ...
          <CardContent className="pt-6 space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">
                      Du bist nicht Mitglied des El Averno Cartel Discord-Servers
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Instructions */}
            <div className="p-5 bg-orange-900/20 border border-orange-500/30 rounded-lg">
              ...
              <ol className="space-y-2 text-sm text-zinc-300 list-decimal list-inside">
                <li>Trete dem <strong className="text-white">El Averno Cartel Discord-Server</strong> bei</li>
            ...
            <div className="p-4 bg-orange-900/20 border border-orange-500/30 rounded-lg">
              <p className="text-orange-300 text-sm text-center">
                ⚠️ Du wirst automatisch in <strong className="text-orange-100">{countdown} Sekunden</strong> abgemeldet
              </p>
            </div>
        ...
        <div className="text-center text-zinc-500 text-sm">
          ...
          <p className="mt-1">El Averno Cartel © 2025</p>
        </div>
      </div>
    </div>
  );
