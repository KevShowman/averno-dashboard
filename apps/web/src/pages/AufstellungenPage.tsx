...
interface Aufstellung {
  ...
  responses: Array<{
    id: string
    status: 'COMING' | 'COMING_LATE' | 'NOT_COMING' | 'UNSURE'
    user: {
      id: string
      username: string
      icFirstName: string
...
export default function AufstellungenPage() {
  ...
  const respondMutation = useMutation({
    mutationFn: ({ id, status }: { id: string; status: 'COMING' | 'COMING_LATE' | 'NOT_COMING' | 'UNSURE' }) =>
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="flex items-center gap-3">
          ...
          <span className="text-zinc-400 text-lg">Lädt Aufstellungen...</span>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      {/* Modern Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-900/40 via-orange-900/30 to-orange-900/40 border border-orange-500/30">
            ...
            {canManageAufstellungen && (
              <div className="flex flex-wrap gap-3">
                <Button
                  ...
                  className="border-orange-500/50 text-orange-300 hover:bg-orange-900/30 hover:border-orange-400 transition-all"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="bg-gradient-to-br from-orange-900/40 to-orange-800/20 rounded-xl p-4 border border-orange-500/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-orange-400">{totalAufstellungen}</div>
                  <div className="text-xs text-orange-300/60 uppercase tracking-wide">Gesamt</div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-orange-900/40 to-orange-800/20 rounded-xl p-4 border border-orange-500/20">
            ...
            <div className="bg-gradient-to-br from-orange-900/40 to-orange-800/20 rounded-xl p-4 border border-orange-500/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-orange-400">{activeExclusions}</div>
                  <div className="text-xs text-orange-300/60 uppercase tracking-wide">Ausschlüsse</div>
                </div>
              </div>
            </div>
      ...
      {myPending && myPending.length > 0 && (
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/30 via-orange-500/30 to-red-500/30 blur-xl opacity-70 group-hover:opacity-100 transition-opacity pointer-events-none" />
          <Card className="relative bg-gradient-to-br from-orange-900/40 via-orange-900/30 to-red-900/40 border-2 border-orange-500/50 shadow-2xl overflow-hidden">
            <CardHeader className="relative pb-4">
              ...
              <CardDescription className="text-orange-200/80 text-base ml-16">
            ...
            <CardContent className="relative space-y-3">
              {myPending.map((auf: Aufstellung) => {
                ...
                return (
                  <div
                    key={auf.id}
                    className="group/item flex items-center justify-between p-4 bg-zinc-900/50 backdrop-blur-sm rounded-xl cursor-pointer hover:bg-zinc-800/70 transition-all duration-300 border border-orange-600/30 hover:border-orange-500/60 hover:shadow-lg hover:shadow-orange-500/10"
                    onClick={() => setSelectedAufstellung(auf.id)}
                  >
                    <div className="flex items-center gap-4 flex-1">
                      <div className="p-3 bg-gradient-to-br from-orange-500/30 to-orange-500/20 rounded-xl group-hover/item:scale-110 transition-transform">
                        <Target className="h-6 w-6 text-orange-400" />
                      </div>
                      <div>
                        <div className="text-white font-semibold text-lg group-hover/item:text-orange-400 transition-colors">
                          {auf.reason}
                        </div>
                        <div className="flex items-center gap-3 text-zinc-300 text-sm mt-1">
                    ...
                    <Button className="bg-gradient-to-r from-orange-600 to-orange-600 hover:from-orange-500 hover:to-orange-500 text-white font-semibold shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all">
      ...
      {canManageAufstellungen && (
        <div className="flex justify-end">
          <Button
            ...
            className="bg-gradient-to-r from-orange-600 to-orange-600 hover:from-orange-500 hover:to-orange-500 text-white font-semibold px-6 py-5 text-base shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge className="bg-orange-900/40 text-orange-300 border-orange-500/50 px-3 py-1">
          ...
          {aufstellungen && aufstellungen.length > 0 ? (
                ...
                return (
                  <div
                    ...
                    className={`group relative overflow-hidden cursor-pointer transition-all duration-300 rounded-xl border ${
                      isSelected 
                        ? 'bg-gradient-to-br from-orange-900/50 to-orange-900/40 border-orange-500 shadow-lg shadow-orange-500/20 scale-[1.02]' 
                        : 'bg-zinc-900/50 border-zinc-800 hover:border-orange-500/50 hover:bg-zinc-900/80 hover:shadow-md'
                    }`}
                    onClick={() => setSelectedAufstellung(auf.id)}
                  >
                    ...
                    <div className="relative p-4">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-start gap-3 flex-1">
                          <div className={`p-2.5 rounded-xl ${isSelected ? 'bg-orange-500/30' : 'bg-orange-500/20'} group-hover:scale-110 transition-transform`}>
                            <MapPin className="h-5 w-5 text-orange-400" />
                          </div>
                          <div className="flex-1">
                            <h3 className={`font-semibold text-lg mb-1 transition-colors ${isSelected ? 'text-orange-300' : 'text-white group-hover:text-orange-300'}`}>
                              {auf.reason}
                            </h3>
                      ...
                      <div className="flex items-center gap-4 pt-3 mt-3 border-t border-zinc-800">
                        ...
                        <div className="flex items-center gap-1.5 text-sm">
                          ...
                          <span className="text-orange-400 font-medium">{auf.responses.filter(r => r.status === 'COMING_LATE').length}</span>
                        </div>
                        <div className="flex items-center gap-1.5 text-sm">
                        ...
                        <div className="flex items-center gap-1.5 text-sm">
                          ...
                          <span className="text-orange-400 font-medium">{auf.responses.filter(r => r.status === 'UNSURE').length}</span>
                        </div>
                        <div className="ml-auto">
                          <Eye className="h-4 w-4 text-zinc-500 group-hover:text-orange-400 transition-colors" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {aufstellungen.length > 3 && (
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-zinc-900/50 hover:bg-zinc-800/70 border border-zinc-800 hover:border-orange-500/30 rounded-xl text-zinc-300 hover:text-white transition-all"
                  >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative p-4">
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex items-start gap-3 flex-1">
                              <div className={`p-2.5 rounded-xl ${isSelected ? 'bg-orange-500/30' : 'bg-orange-500/20'}`}>
                                <MapPin className="h-5 w-5 text-orange-400" />
                              </div>
                              <div className="flex-1">
                                <h3 className={`font-semibold text-lg mb-1 transition-colors ${isSelected ? 'text-orange-300' : 'text-white group-hover:text-orange-300'}`}>
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-12 text-center">
              ...
              <p className="text-zinc-400 text-lg">Noch keine Aufstellungen erstellt</p>
              <p className="text-zinc-500 text-sm mt-1">Erstelle die erste Aufstellung für deine Familia</p>
            </div>
          )}
        </div>
        ...
        {selectedAufstellung && aufstellungDetails && (
          <div className="space-y-4 lg:sticky lg:top-6">
            ...
            <div className="space-y-4">
              {/* Header Card */}
              <Card className="bg-gradient-to-br from-zinc-900 to-zinc-800/80 border-orange-500/30 shadow-xl">
                <CardHeader className="border-b border-orange-500/20 pb-4">
                  <CardTitle className="text-2xl text-orange-300 mb-2">{aufstellungDetails.reason}</CardTitle>
                ...
                <CardContent className="pt-6 space-y-6">
                  ...
                  {!isDeadlinePassed(aufstellungDetails.deadline) && (
                    <div className="bg-zinc-800/50 p-4 rounded-xl border border-orange-500/20">
                        ...
                        <Button
                          ...
                          className={`h-12 transition-all ${
                            getMyResponse(aufstellungDetails)?.status === 'COMING'
                              ...
                              : 'border-zinc-600 hover:border-green-500 hover:bg-green-900/20 text-zinc-300 hover:text-green-400'
                          }`}
                          onClick={() =>
                        ...
                        <Button
                          ...
                          className={`h-12 transition-all ${
                            getMyResponse(aufstellungDetails)?.status === 'COMING_LATE'
                              ? 'bg-orange-600 hover:bg-orange-500 border-orange-500 shadow-lg shadow-orange-500/20 text-white'
                              : 'border-zinc-600 hover:border-orange-500 hover:bg-orange-900/20 text-zinc-300 hover:text-orange-400'
                          }`}
                          onClick={() =>
                            respondMutation.mutate({
                              id: selectedAufstellung,
                        ...
                        <Button
                          ...
                          className={`h-12 transition-all ${
                            getMyResponse(aufstellungDetails)?.status === 'NOT_COMING'
                              ...
                              : 'border-zinc-600 hover:border-red-500 hover:bg-red-900/20 text-zinc-300 hover:text-red-400'
                          }`}
                          onClick={() =>
                            respondMutation.mutate({
                              id: selectedAufstellung,
                        ...
                        <Button
                          ...
                          className={`h-12 transition-all ${
                            getMyResponse(aufstellungDetails)?.status === 'UNSURE'
                              ? 'bg-orange-600 hover:bg-orange-500 border-orange-500 shadow-lg shadow-orange-500/20 text-zinc-900'
                              : 'border-zinc-600 hover:border-orange-500 hover:bg-orange-900/20 text-zinc-300 hover:text-orange-400'
                          }`}
                          onClick={() =>
                            respondMutation.mutate({
                  ...
                  {aufstellungDetails.stats && (
                    <div className="bg-zinc-800/50 p-4 rounded-xl border border-orange-500/20">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="col-span-2 group relative overflow-hidden bg-gradient-to-br from-orange-900/50 to-orange-800/30 p-4 rounded-xl border border-orange-500/30 hover:border-orange-500/60 transition-all">
                          <div className="relative">
                    ...
                    <div className="space-y-3">
                      ...
                      {aufstellungDetails.responses.filter((r: any) => r.status === 'COMING_LATE').length > 0 && (
                        <div className="bg-zinc-800/50 p-4 rounded-xl border border-orange-500/30">
                          ...
                          <div className="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
                            {aufstellungDetails.responses
                              .filter((r: any) => r.status === 'COMING_LATE')
                              .map((r: any) => (
                                <div
                                  key={r.id}
      ...
      {showExclusions && canManageAufstellungen && (
        <Card className="bg-gradient-to-br from-zinc-900/80 to-zinc-800/50 border-orange-500/30">
          <CardHeader>
            ...
            {exclusionsLoading ? (
              ...
              <div className="space-y-3">
                {exclusions.map((exclusion: any) => (
                  <div
                    key={exclusion.id}
                    className="flex items-center justify-between p-4 bg-zinc-800/50 border border-zinc-700 hover:border-orange-500/30 rounded-xl transition-all"
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-zinc-400 mt-1">{exclusion.reason}</div>
                      <div className="text-xs text-zinc-500 mt-1 flex items-center gap-2">
                        ...
                        {exclusion.startDate && exclusion.endDate
                          ...
                          : 'Dauerhaft'}
                        {!exclusion.isActive && (
                          <Badge className="bg-orange-900/40 text-orange-300 border-orange-500/50 text-xs">
                            Deaktiviert
                          </Badge>
                        )}
                      </div>
              ...
              <div className="text-center text-zinc-400 py-8">
                <div className="p-4 bg-zinc-800/50 rounded-2xl w-fit mx-auto mb-4">
                  <UserX className="h-12 w-12 text-zinc-600" />
                </div>
